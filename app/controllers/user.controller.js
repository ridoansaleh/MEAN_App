...
userController.$inject = ['$scope', '$rootScope', 'userService', '$state', '$stateParams'];

function userController($scope, $rootScope, userService, $state, $stateParams) {
  $scope.users = [];

  $scope.hello = "Hi, Ridoan";
